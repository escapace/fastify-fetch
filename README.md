...
## const fastifyFetch [↗](src/fastify-fetch.ts#L717-L739 'fastifyFetch')
...
## interface FastifyFetchCallOverrides [↗](src/types.ts#L196-L206 'FastifyFetchCallOverrides')
...
## interface FastifyFetchInit [↗](src/types.ts#L213-L221 'FastifyFetchInit')
...
## interface FastifyFetchOptions [↗](src/types.ts#L226-L252 'FastifyFetchOptions')
...
## interface FastifyFetchPolicy [↗](src/types.ts#L111-L187 'FastifyFetchPolicy')
...
## interface FastifyFetchRouteContext [↗](src/types.ts#L41-L71 'FastifyFetchRouteContext')
...
## type FastifyFetch [↗](src/types.ts#L261 'FastifyFetch')
...
## type FastifyFetchBoundaryPolicy [↗](src/types.ts#L26 'FastifyFetchBoundaryPolicy')
...
## type FastifyFetchContract [↗](src/types.ts#L18 'FastifyFetchContract')
...
## type FastifyFetchOverflowPolicy [↗](src/types.ts#L36 'FastifyFetchOverflowPolicy')
...
## type FastifyFetchRoute [↗](src/types.ts#L99 'FastifyFetchRoute')
...
## type FastifyFetchRouteDecision [↗](src/types.ts#L79-L91 'FastifyFetchRouteDecision')
...
## type FastifyFetchTransport [↗](src/types.ts#L10 'FastifyFetchTransport')
